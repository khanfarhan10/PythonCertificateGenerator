...
if __name__== "__main__":
    # code here
    InputFilepath = 'Government_Certificate_Sample.docx'
    IntermediateFilepath = 'Government_Certificate_Generated_Intermediate.docx'
    OutputFilepath = 'Government_Certificate_Generated_Final.docx'
    OutputDirectory='/tempfiles/'
    SrcImgFilePath='ReplacementImage.png'
