...
def nothing():
    ...
    doc = DocxTemplate("templates/1.docx")
    context = {'YOUR_AWESOME_NAME': "Farhan Hai Khan"}
    doc.render(context)
...
import docx
doc = docx.Document("templates/1.docx")
docx_replace(doc, dict(ItemOne='YOUR_AWESOME_NAME', ItemTwo="Farhan Hai Khan"))
doc.save('outputs/generated_doc.docx')
